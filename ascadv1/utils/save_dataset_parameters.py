...
# Le module pickle est utilisé pour la sérialisation et la désérialisation d'objets Python. 
# Il permet de sauvegarder des objets complexes dans des fichiers et de les recharger plus tard.
import pickle
import numpy as np
...
DATASET_FOLDER= ''  
FILE_DATASET = "ascadv1/Ascad_v1_dataset_full.h5" 
# FILE_DATASET = "Ascad_v1_dataset_full.h5"
PROJECT_FOLDER = 'ascadv1_mtl'  
